    ...
    override fun emit(softwareContext: IrSoftwareContext, directory: Path) {
        ...
        LinuxLinker.linkObjectFilesToELF(
            listOf(
                ...
                getClasspathResourceAsFileOnDisk(javaClass, "/io/github/tmarsteel/emerge/backend/llvm/x86_64-pc-linux-gnu/unwind-c.o"),
                getClasspathResourceAsFileOnDisk(javaClass, "/io/github/tmarsteel/emerge/backend/llvm/x86_64-pc-linux-gnu/unwind-dw2-fde-dip.o"),
                getClasspathResourceAsFileOnDisk(javaClass, "/io/github/tmarsteel/emerge/backend/llvm/x86_64-pc-linux-gnu/unwind-dw2.o"),
                getClasspathResourceAsFileOnDisk(javaClass, "/io/github/tmarsteel/emerge/backend/llvm/x86_64-pc-linux-gnu/libbacktrace.a"),
            ),
            executablePath,
