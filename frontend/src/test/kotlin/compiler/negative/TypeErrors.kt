    ...
    "generics" - {
        ...
        "reference to generic type with no type arguments when they are required" {
            validateModule("""
                ...
                fn test(p: X) {}
            """.trimIndent())
                .shouldReport<MissingTypeArgumentDiagnostic> {
        ...
        "reference to generic type with too many type arguments when they are required" {
            ...
            """.trimIndent())
                .shouldReport<SuperfluousTypeArgumentsDiagnostic> {
        ...
        "reference to generic type with mismatching parameter variance" {
            validateModule("""
                ...
                fn test(p: X<out Any>) {}
            """.trimIndent())
                .shouldReport<TypeArgumentVarianceMismatchDiagnostic>()
        ...
        "reference to generic type with superfluous parameter variance" {
            validateModule("""
                ...
                fn test(p: X<in Any>) {}
            """.trimIndent())
                .shouldReport<TypeArgumentVarianceSuperfluousDiagnostic>()
        }
        ...
        "use-site variance errors" - {
            "in type at class member" {
                ...
                """.trimIndent())
                    .shouldReport<UnsupportedTypeUsageVarianceDiagnostic>()
            }
        }
