...
class BoundForEachLoop(
    ...
    override val throwBehavior: SideEffectPrediction?
        get() = rangeHolderDeclaration.throwBehavior.combineSequentialExecution(body.throwBehavior)
    override val returnBehavior: SideEffectPrediction?
        get() = rangeHolderDeclaration.returnBehavior.combineSequentialExecution(
            SideEffectPrediction.NEVER.combineBranch(body.returnBehavior)
        )
    ...
    override fun setNothrow(boundary: NothrowViolationDiagnostic.SideEffectBoundary) {
        ...
        // TODO: the hidden invocation to range.popFront is not covered, yet!!
    }
