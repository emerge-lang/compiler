...
fun parseFromClasspath(path: String, packageName: DotName): ASTSourceFile = parseFromClasspath(Paths.get(path), packageName)

fun parseFromClasspath(path: Path, packageName: DotName): ASTSourceFile {
